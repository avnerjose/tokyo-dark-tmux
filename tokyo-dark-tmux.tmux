...
build_window_icon() {
  local window_status_icon_enable=$(get_tmux_option "@tokyo_window_status_icon_enable" "yes")

  local custom_icon_window_last=$(get_tmux_option "@tokyo_icon_window_last" "󰖰")
  local custom_icon_window_current=$(get_tmux_option "@tokyo_icon_window_current" "󰖯")
  local custom_icon_window_zoom=$(get_tmux_option "@tokyo_icon_window_zoom" "󰁌")
  local custom_icon_window_mark=$(get_tmux_option "@tokyo_icon_window_mark" "󰃀")
  local custom_icon_window_silent=$(get_tmux_option "@tokyo_icon_window_silent" "󰂛")
  local custom_icon_window_activity=$(get_tmux_option "@tokyo_icon_window_activity" "󰖲")
  local custom_icon_window_bell=$(get_tmux_option "@tokyo_icon_window_bell" "󰂞")
...
build_window_format() {
  ...
  if [ "$fill" = "none" ]
  then
    local show_left_separator="#[fg=$thm_black,bg=$thm_bg,nobold,nounderscore,noitalics]$window_left_separator"
    local show_number="#[fg=$thm_fg,bg=$thm_black]$number"
    local show_middle_separator="#[fg=$thm_fg,bg=$thm_black,nobold,nounderscore,noitalics]$window_middle_separator"
    local show_text="#[fg=$thm_fg,bg=$thm_black]$text"
    local show_right_separator="#[fg=$thm_black,bg=$thm_bg]$window_right_separator"
...
build_status_module() {
  ...
  then
    ...
    local show_right_separator="#[fg=$color,bg=$thm_black,nobold,nounderscore,noitalics]$status_right_separator"
...
main() {
  ...
  # messages
  set message-style "fg=${thm_cyan},bg=${thm_black},align=centre"
  set message-command-style "fg=${thm_cyan},bg=${thm_black},align=centre"
  ...
  local window_left_separator=$(get_tmux_option "@tokyo_window_left_separator" "█")
  local window_right_separator=$(get_tmux_option "@tokyo_window_right_separator" "█")
  local window_middle_separator=$(get_tmux_option "@tokyo_window_middle_separator" "█ ")
  local window_number_position=$(get_tmux_option "@tokyo_window_number_position" "left") # right, left
  local window_status_enable=$(get_tmux_option "@tokyo_window_status_enable" "no") # right, left
  ...
  local status_left_separator=$(get_tmux_option "@tokyo_status_left_separator" "")
  local status_right_separator=$(get_tmux_option "@tokyo_status_right_separator" "█")
  local status_right_separator_inverse=$(get_tmux_option "@tokyo_status_right_separator_inverse" "no")
  local status_connect_separator=$(get_tmux_option "@tokyo_status_connect_separator" "yes")
  local status_fill=$(get_tmux_option "@tokyo_status_fill" "icon")

  local status_modules_right=$(get_tmux_option "@tokyo_status_modules_right" "application session")
  local loaded_modules_right=$( load_modules "$status_modules_right")

  local status_modules_left=$(get_tmux_option "@tokyo_status_modules_left" "")
